<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="frmGestionarHorario2.aspx.cs" Inherits="CapaPresentacion.frmGestionarHorario2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
                ...
                <div class="box box-primary">
                        ...
                        <asp:GridView ID="grvHorarioAtencion" CssClass="table table-condensed"  runat="server" OnSelectedIndexChanged="grvHorarioAtencion_Editar">
                            <Columns>
                                <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="70px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkbtnEditar" runat="server" CssClass="btn btn-sm btn-warning" href="#ModificarHorario2" Text="Editar" OnClick="grvHorarioAtencion_Editar" CommandName="Select" data-toggle="modal"  />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
                    ...
                    <div class="box-footer">
                        <table align="center">
                            <tr>
                                <td>
                                    <asp:LinkButton ID="lnkbtnAgregar" CssClass="btn btn-primary" runat="server" href="#AgregarHorario2" data-toggle="modal" >Agregar Horario</asp:LinkButton>
        ...
        <div class="modal fade" id="AgregarHorario2"  tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtFecha2" CssClass="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" runat="server"></asp:TextBox>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="ModificarHorario2"  tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
