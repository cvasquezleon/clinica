...
namespace CapaPresentacion
{
    public partial class frmGestionarHorario : System.Web.UI.Page
    {
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            if (objHorarioAtencion.ComprobarFecha(Convert.ToDateTime(txtFecha.Text)))
            {
        ...
        private DataTable CrearTablaHorarioAtencion(List<entHorarioAtencion> Lista)
        {
            ...
            foreach (entHorarioAtencion objHorarioAtencion in Lista)
            {
                ...
                dr["ESTADO"] = "1";
                //((Label)Page.FindControl("lblEstado")).CssClass = "label label-success";
                //((Label)Page.FindControl("lblEstado")).Text = "Disponible";
