            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <asp:GridView ID="grvHorarioAtencion" CssClass="table table-condensed"  runat="server" OnSelectedIndexChanged="grvHorarioAtencion_SelectedIndexChanged">
                            <Columns>
                                <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="70px">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkbtnEditar" runat="server" CssClass="btn btn-sm btn-warning" href="#ModificarHorario" Text="Editar" CommandName="Select" data-toggle="modal" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <Columns>
